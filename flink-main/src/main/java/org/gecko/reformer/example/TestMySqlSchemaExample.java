...
import org.gecko.reformer.schema.TestSchema;
import org.gecko.reformer.util.FlinkUtils;

public class TestMySqlSchemaExample {
    public static void main(String[] args) throws Exception {
        ...
        final TestSchema schema = new TestSchema();

        final DataStreamSource<TestModel> source = FlinkUtils.getMysqlSource(dto, schema);
