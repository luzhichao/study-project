 ...
 **/
@Data
@Table(name = "test_table1", comment = "测试表1", engine = EngineConstant.InnoDB, charset = CharsetConstant.UTF8MB4)
public class TestTable1 extends BaseEntity {
    private static final long serialVersionUID = 1L;

    @Unique(value = "test_table1_unique_1", columns = {"name", "info_report", "alarm_mode"})
    @Column(value = "name", comment = "姓名", length = 50)
    private String name;
    @Column(value = "age", comment = "年龄", length = 3, defaultValue = "20")
    private Integer age;

    @Index(value = "test_table1_index_1", columns = {"birthday", "longitude", "latitude"})
